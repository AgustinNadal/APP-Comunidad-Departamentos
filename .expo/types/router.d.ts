...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(app)` | `/_sitemap` | `/alertas/alerta_datos_wifi` | `/denuncia` | `/denuncias/crear_denuncia` | `/denuncias/denuncias_entrantes` | `/denuncias/mis_denuncias` | `/home` | `/inicio` | `/login/cambiar_password` | `/login/login_screen` | `/login/recuperar_password` | `/login/register_screen` | `/reclamo` | `/reclamos/crear_reclamo` | `/reclamos/lista_reclamos` | `/reclamos/mis_reclamos` | `/services/axiosConfig` | `/services/userService` | `/servicio` | `/servicios/ofrecer_servicio` | `/servicios/x_servicio`;
