...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(app)` | `/Inspector/alertas/alerta_datos_wifi` | `/Inspector/denuncias/crear_denuncia` | `/Inspector/denuncias/denuncias_entrantes` | `/Inspector/denuncias/mis_denuncias` | `/Inspector/inicio` | `/Inspector/login/login_screen` | `/Inspector/reclamos/crear_reclamo` | `/Inspector/reclamos/lista_reclamos` | `/Inspector/reclamos/mis_reclamos` | `/Inspector/servicios/x_servicio` | `/Publico/alertas/alerta_datos_wifi` | `/Publico/inicio` | `/Publico/login/cambiar_password` | `/Publico/login/cambiar_password_inspector` | `/Publico/login/login_inspector` | `/Publico/login/login_screen` | `/Publico/login/recuperar_password` | `/Publico/login/register_screen` | `/Publico/servicios/ofrecer_servicio` | `/Publico/servicios/x_servicio` | `/Vecino/alertas/alerta_datos_wifi` | `/Vecino/denuncias/crear_denuncia` | `/Vecino/denuncias/denuncias_entrantes` | `/Vecino/denuncias/mis_denuncias` | `/Vecino/inicio` | `/Vecino/login/login_screen` | `/Vecino/reclamos/crear_reclamo` | `/Vecino/reclamos/lista_reclamos` | `/Vecino/reclamos/mis_reclamos` | `/Vecino/servicios/ofrecer_servicio` | `/Vecino/servicios/x_servicio` | `/Vecino/test/test` | `/_sitemap` | `/denuncia` | `/home` | `/reclamo` | `/servicio`;
