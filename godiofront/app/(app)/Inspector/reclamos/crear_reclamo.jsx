...
export default function crear_reclamo() {
  ...
  const sendStoredReclamos = async () => {
    ...
    for (const reclamo of reclamosGuardados) {
      try {
        const response = await axios.post(`http://192.168.0.73:8080/inicio/reclamo/personal?legajo=${legajo}&idsitio=${sitio}&iddesperfecto=${desperfecto}&descripcion=${descripcion}`, reclamo);
  ...
  const handleCrearReclamo = async () => {
    const reclamo = await axios.post(`http://192.168.0.73:8080/inicio/reclamo/personal?legajo=${legajo}&idsitio=${sitio}&iddesperfecto=${desperfecto}&descripcion=${descripcion}`,{
      legajo,
      sitio,
      desperfecto,
      descripcion,
    ...
    try {
      const response = await axios.post(`http://192.168.0.73:8080/inicio/reclamo/personal`, reclamo);
